...
- 学生可以修改密码，教师可以创建账号、停用账号和重置密码
- 教师端新增“学生端管理”，集中管理教师、学生账号、ZIP 课件、测评、作业、作品审核和活动报名
- 已适配电脑、平板和手机

本地体验账号为 `student01`，密码为 `123456`。当前学生端数据保存在浏览器本地，方便在服务器购买前完成交互验收；正式部署时需要接入服务器数据库、对象存储、ZIP 解压服务和 Tkinter/Pygame 虚拟运行器。
